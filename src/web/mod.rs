...
const SETTING_FIELDS: &[SettingField] = &[
    ...
    SettingField {
        key: "GOOGLE_OAUTH_CREDENTIALS_PATH",
        label: "Google OAuth Credentials Path",
        help: "Path to Google OAuth client credentials.json used to bootstrap token.json with `cargo run -- google-auth`.",
        secret: false,
        multiline: false,
    },
    SettingField {
        key: "GOOGLE_OAUTH_TOKEN_PATH",
        label: "Google OAuth Token Path",
        help: "Path to a Google authorized_user token.json file. Preferred over a raw access token.",
        secret: false,
        multiline: false,
    },
    SettingField {
        key: "GOOGLE_CALENDAR_ACCESS_TOKEN",
        label: "Google Calendar Access Token (Legacy)",
        help: "Legacy fallback bearer token for Google Calendar API.",
        secret: true,
        multiline: false,
    },
    SettingField {
